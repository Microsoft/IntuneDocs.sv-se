...
description: "Förhandsversion av Intune Azure: Intune tillhandahåller verktyg för att tilldela en ny etableringsprofil till enheter som har appar som snart upphör att gälla."
keywords: 
author: robstackmsft
ms.author: robstack
manager: angrobe
...
Koppla profilen till nödvändiga iOS-enheter. Mer information finns i stegen i [Så här tilldelar du enhetsprofiler](../configure-devices/how-to-assign-device-profiles.md).
