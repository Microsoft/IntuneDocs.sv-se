---
title: "Lägga till Windows Store-appar i Intune | Förhandsversion av Intune Azure | Microsoft Docs"
...
# <a name="how-to-add-windows-store-apps-to-intune"></a>Lägga till Windows Store-appar i Intune
