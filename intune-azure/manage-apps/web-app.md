...
description: "Förhandsversion av Intune Azure: Läs mer om att lägga till webbappar i Intune."
keywords: 
author: robstackmsft
ms.author: robstack
manager: angrobe
...
# <a name="how-to-add-web-apps-to-intune"></a>Så här lägger du till webbappar till Intune
