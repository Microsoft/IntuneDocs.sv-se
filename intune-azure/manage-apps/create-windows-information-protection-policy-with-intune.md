...
-   Läs mer i [Konfigurera din MAM-provider med Intune](https://docs.microsoft.com/intune-azure/manage-apps/get-ready-to-configure-app-protection-policies-for-windows-10).
...
När du konfigurerar Intune i din organisation kan du skapa en RIA-specifik princip via [Azure Portal](https://docs.microsoft.com/intune/deploy-use/azure-portal-for-microsoft-intune-mam-policies).
