---
title: "Intunes VPN-inställningar för Windows Phone 8.1-enheter | Förhandsversion av Intune Azure | Microsoft Docs"
description: "Förhandsversion av Intune Azure: Lär dig mer om Intune-inställningar som du kan använda för att konfigurera VPN-anslutningar på Windows Phone 8.1-enheter."
keywords: 
author: robstackmsft
ms.author: robstack
manager: angrobe
