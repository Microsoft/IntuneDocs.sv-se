...
# <a name="email-profile-settings-for-android-devices-in-intune-azure-preview"></a>Inställningar för e-postprofil för Android-enheter i förhandsversionen av Intune Azure
