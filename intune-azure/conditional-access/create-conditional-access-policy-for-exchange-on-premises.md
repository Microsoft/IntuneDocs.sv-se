...
- Du måste använda [Exchange Active Syncs lokala Exchange Connector](install-intune-on-premises-exchange-connector.md) som ansluter Intune till Exchange lokalt.
