...
|**Skapa systemåterställningspunkt före korrigering av skadlig kod**|Ange till **Ja** att skapa en återställningspunkt för Windows-systemet innan du påbörjar åtgärder mot skadlig kod.<br /><br />Rekommenderat värde: **Ja**|
|**Spåra löst skadlig kod (dagar)**|Gör att Endpoint Protection kan spåra skadlig kod som har åtgärdats under en viss tid så att du kan kontrollera datorer som har påverkats tidigare manuellt.<br /><br />Du kan ange ett värde mellan 0 och 30 dagar.<br /><br />Rekommenderat värde: **7 dagar**|
...
Mer hjälp och support finns i [Felsöka slutpunktsskydd i Microsoft Intune](/intune-classic/troubleshoot/troubleshoot-endpoint-protection-in-microsoft-intune).
