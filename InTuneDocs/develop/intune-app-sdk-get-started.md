...
Den här guiden hjälper dig att snabbt aktivera din mobilapp för appskyddsprinciper med Microsoft Intune. Det kan vara bra att först förstå fördelarna med Intune App SDK:n som räknas upp i [Intune App SDK-översikt](intune-app-sdk.md).
...
* **[Utvecklarguide för Intune App SDK för iOS](intune-app-sdk-ios.md)**: Det här dokumentet beskriver steg för steg hur du aktiverar din interna iOS-app med Intune App SDK.

* **[Utvecklarhandbok för Intune App SDK för Android](intune-app-sdk-android.md)**: Det här dokumentet beskriver steg för steg hur du aktiverar din interna Android-app med Intune App SDK.

* **[Guide för plugin-programmet Intune App SDK Cordova](intune-app-sdk-cordova.md)**: Det här dokumentet hjälper dig att skapa iOS- och Android-appar med Cordova för Intunes appskyddsprinciper.

* **[Guide för Intune App SDK Xamarin-komponenten](intune-app-sdk-xamarin.md)**: Det här dokumentet hjälper dig att skapa iOS- och Android-appar med Cordova för Intunes appskyddsprinciper.
...
* **Intunes appskyddsprinciper**: För att testa din app mot alla Intunes appskyddsprinciper bör du veta vad det förväntade beteendet för varje principinställning är. Se beskrivningarna för [iOS-appskyddsprinciper](../deploy-use/ios-mam-policy-settings.md) och [Android-appskyddsprinciper](../deploy-use/android-mam-policy-settings.md).

* **Felsök**: Om du stöter på problem vid manuell testning av hur användare interagerar med din app kan du även läsa informationen om att [felsöka MAM](../troubleshoot/troubleshoot-mam.md). Den här artikeln hjälper dig med vanliga problem, dialogrutor och felmeddelanden som kan uppstå i Intune-upplysta appar. 
...
![Skyltexempel 1](../media/intune-app-badge/example-1.png) ![Skyltexempel 2](../media/intune-app-badge/example-2.png)
