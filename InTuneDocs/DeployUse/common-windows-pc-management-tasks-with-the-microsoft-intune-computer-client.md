...
## <a name="use-policies-to-simplify-pc-management"></a>Använd principer för att förenkla datorhantering
...
## <a name="view-hardware-and-software-inventory"></a>Visa maskinvaru- och programvaruinventering.
...
### <a name="to-display-information-about-your-computers"></a>Så här visar du information om datorerna
...
### <a name="to-display-software-installed-on-your-computers"></a>Så här ser du vilka program som är installerade på datorerna
...
## <a name="retire-a-computer"></a>Dra tillbaka en dator
...
## <a name="manage-user-device-linking"></a>Hantera länkning av användarenheter
...
### <a name="to-link-a-user-to-a-computer"></a>Så här länkar du en användare till en dator
