...
|Ange utfärdare för hantering av mobila enheter till Intune|[Ange utfärdare för mobila enheter till Intune](get-ready-to-enroll-devices-in-microsoft-intune.md#BKMK_Set_MDM_Authority)|
...
4.  På sidan **Konfigurera Exchange Connection** väljer du **Hämta On-Premises Connector**
