...
-  Om du ser en länk till Azure Portal så använder du inte längre Intune-grupper. Följ proceduren [Så konfigurerar du mappning av enhetsgrupper (för Azure Active Directory-grupper)](##Så-konfigurerar-du-mappning-av-enhetsgrupper-(för-Azure-Active-Directory-grupper) nedan.
-  Om du inte ser en länk till Azure Portal så använder du fortfarande Intune-grupper. Följ proceduren [Så konfigurerar du mappning av enhetsgrupper (för Intune-grupper)](##Så-konfigurerar-du-mappning-av-enhetsgrupper-(för-Intune-grupper) nedan.
