...
-   Läs mer i [Konfigurera din MAM-provider med Intune](https://docs.microsoft.com/intune/deploy-use/get-ready-to-configure-app-protection-policies-for-windows-10).
