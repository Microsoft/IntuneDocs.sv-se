...
### <a name="step-3-configure-enrollment-groups"></a>Steg tre: Konfigurera registrering av grupper
...
### <a name="step-6-configure-enrollment-settings"></a>Steg 6. Konfigurera registreringsinställningar
