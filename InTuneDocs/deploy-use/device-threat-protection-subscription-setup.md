...
Följande steg krävs för att konfigurera Lookout-skydd mot enhetshot:
...
Din Lookout Mobility Endpoint Security-klient kommer att associeras med din Azure AD-prenumeration för att integrera Lookout med Intune. Om du vill aktivera tjänsteprenumeration för Lookout-skydd mot enhetshot behöver Lookout-supporten (enterprisesupport@lookout.com) följande information:  
...
>[!IMPORTANT]
> Risknivåerna är en viktig aspekt av skydd mot enhetshot eftersom Intune-integrationen beräknar enhetens efterlevnad enligt dessa risknivåer vid körning. Intune-administratören anger en regel i principen för att identifiera att en enhet är icke-kompatibel om den har ett aktivt hot med miniminivån **Hög**, **Medel** eller **Låg**. Principen för hotklassificering i Lookout-skydd mot enhetshot styr direkt efterlevnadsberäkningen för enheten i Intune.
