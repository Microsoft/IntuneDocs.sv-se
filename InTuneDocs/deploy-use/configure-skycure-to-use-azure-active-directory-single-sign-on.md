---
title: "Konfigurera Skycure till att använda enkel inloggning (SSO) med Azure Active Directory | Microsoft Docs"
...
[Hämta konfigurationsprincip för Skycures iOS-app](https://docs.microsoft.com/intune/deploy-use/download-skycure-ios-app-configuration-policy)
