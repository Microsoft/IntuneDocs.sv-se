...
ms.topic: hub-page
title: Microsoft Intune-dokumentation | Microsoft Docs
description: "Lär dig att använda Microsoft Intune (FIXME)"
...
<div class="container">
    ...
    <ul class="pivots">
        <li>
            <a href="#manage">Hantera</a>
            <ul id="manage">
                <li>
                    <a href="#manage-featured">Aktuella artiklar</a>
                    <ul id="manage-featured" class="cardsC">
                        <li>
                            <div>
                                <h3 style="font-size: 1.4rem; margin-top: 0px; margin-left: 11px;">Populära artiklar</h3>
                            </div>
                        </li>
                        <li>
                            <div>
                                <h3 style="font-size: 1.4rem; margin-top: 0px; margin-left: 11px;">Rekommenderade artiklar</h3>
                            </div>
                        </li>
                        <li>
                            <div>
                                <h3 style="font-size: 1.4rem; margin-top: 0px; margin-left: 11px;">Nya artiklar</h3>
                            </div>
                        </li>
                        <li>
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="/intune-azure/introduction/what-is-microsoft-intune">Förhandsgranskning av Intune i Azure Portal</a></h3>
                                            <p>Läs om ändringarna i de nya portalen nu när Microsoft Intune flyttas till Azure Portal. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="/intune/plan-design/introduction">Distributionsplanering och design</a></h3>
                                            <p>Gå stegvis igenom hela processen med att utveckla en distributionsplan, skapa en design, integrera Intune och genomföra en produktionsdistribution.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="/intune/deploy-use/how-to-educate-your-end-users-about-microsoft-intune">Informera slutanvändare om Microsoft Intune</a></h3>
                                            <p>Lär dig hur du kan få dina slutanvändare att använda den säkra åtkomst som Intune tillhandahåller.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="https://graph.microsoft.io/en-us/docs/api-reference/beta/resources/intune_graph_overview">Arbeta med Intune i Microsoft Graph</a></h3>
                                            <p>Använd Microsoft Graph API:erna när du ska konfigurera Intunes kontroller och principer.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="https://docs.microsoft.com/en-us/enterprise-mobility-security/solutions/enterprise-mobility-fasttrack-program">Har du fler än 150 licenser? Utnyttja dina FastTrack-förmåner</a></h3>
                                            <p>Arbeta tillsammans med Microsofts experter för att få åtkomst till, åtgärda, aktivera och implementera användningen av dina tjänster.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="/intune/understand-explore/mam-faq">Vanliga frågor och svar om MAM och appskydd</a></h3>
                                            <p>Hitta svaren på några vanliga frågor om Intunes hantering av mobilappar och dess appskydd.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Se <a href="/intune/understand-explore/introduction-to-microsoft-intune">all Intune-dokumentation</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#manage-intro">Introduktion</a>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Lär dig hur Intune tillhandahåller funktioner för hantering av enheter, program och data för mobila enheter och Windows-datorer.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Hantering av mobilenheter i Microsoft Intune</h3>
                                            <p>Utvärdera hur hanteringen av mobilenheter fungerar i Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Se <a href="/intune/understand-explore/introduction-to-microsoft-intune">all introduktionsdokumentation</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
               <!-- <li>
                ...
                <li>
                    <a href="#manage-plan">Planera distribution</a>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Fastställa mål och utmaningar</h3>
                                            <p>Definiera de mål och utmaningar du måste hantera i samband med distribution.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Identifiera scenarion för användningsfall</h3>
                                            <p>Granska några användningsfall när du identifierar dina användningsfallsscenarion för distribution. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Utveckla en distributionsplan</h3>
                                            <p>Bestäm vilka organisationsgrupper som Intune-distributionen ska riktas in på och vilken tidsram distributionen ska ha för respektive grupp.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Se <a href="/intune/plan-design/introduction">all dokumentation om plandistributionen</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#manage-howto">Gör så här</a>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Skapa en princip för villkorlig åtkomst</h3>
                                            <p>Konfigurera villkorlig åtkomst lokalt för Exchange utifrån enhetsefterlevnad.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Ange MDM-utfärdare</h3>
                                            <p>Läs mer om vilka alternativ som är tillgängliga när du ställer in utfärdare av hantering av mobila enheter.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Konfigurera enhetsprofiler</h3>
                                            <p>Så här skapar du profiler för enhetskonfiguration i Microsoft Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Konfigurera enhetsbegränsningar</h3>
                                            <p>Lär dig hur du konfigurerar enhetsbegränsningar i Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Hantera appar</h3>
                                            <p>Lär dig hur du lägger till, tilldelar och övervakar appar.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Skapa och tilldela skyddsprinciper för appar</h3>
                                            <p>Lär dig hur du skapar och tilldelar skyddsprinciper för appar.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Se <a href="/intune/deploy-use/overview-of-device-and-app-lifecycles-in-microsoft-intune">all dokumentation med instruktioner</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#manage-troubleshoot">Övervaka och felsöka</a>
                    <ul id="manage-troubleshoot" class="cardsC">
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Kända problem</h3>
                                            <p>Läs om kända problem i förhandsversionen av Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Felsöka problem med appdistribution</h3>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Felsöka enhetsprofiler</h3>
                                            <p>Lösa problem som kan uppstå när du skapar enhetsprofiler.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Felsöka e-postprofiler</h3>
                                            <p>Lösa problem som kan uppstå när du skapar e-postprofiler.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Se <a href="/intune/troubleshoot/general-troubleshooting-tips-for-microsoft-intune">all felsökningsdokumentation</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
            ...
            <ul id="sdkstools">
                <li>
                    ...
                    <ul id="sdkstools-all" class="cardsC">                       
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Översikt över Intune App SDK</h3>
                                            <p>Läs mer om den SDK som du kan använda när du ska aktivera din app för Intunes appskyddsprinciper.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Den här guiden går igenom de viktigaste stegen som krävs när du ska aktivera hantering av mobilappar i din app med Microsoft Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Intunes App-SDK för iOS innehåller ett statiskt bibliotek, resursfiler, API-rubriker, en lista med felsökningsinställningar och ett konfigurationsverktyg.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Arbeta med Intune i Microsoft Graph</h3>
                                            <p>Använd Microsoft Graph API:erna när du ska konfigurera Intunes kontroller och principer.</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Förbereda affärsappar för MAM</h3>
                                            <p>Aktivera dina appar så att de kan använda principer för hantering av mobilprogram (MAM) med hjälp av Intunes apphanteringsverktyg eller dess app-SDK.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Vill du se all dokumentation? Se <a href="/intune/understand-explore/introduction-to-microsoft-intune">all Intune-dokumentation</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Följ Microsoft Intune på Twitter</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Ställ och besvara frågor på forumet</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Läs bloggen om Enterprise Mobility and Security</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Ge feedback om Intune-tjänsten</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Ge feedback för Intune-dokumentation</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
