...
## Använda Intune-företagsportalappen för Windows 
### [Kontrollera enhetsåtkomsten](check-device-access-windows-cpapp.md)
### [Installera appar från företagsportalappen](install-apps-cpapp-windows.md) 
### [Fjärrlåsa en enhet från företagsportalappen](remote-lock-your-device-cp-app.md)   
### [Byta namn på enheten från företagsportalappen](rename-your-device-cpapp.md) 
