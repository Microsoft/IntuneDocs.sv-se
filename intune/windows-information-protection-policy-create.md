...
-   Läs mer i [Konfigurera din MAM-provider med Intune](https://docs.microsoft.com/app-protection-policies-configure-windows-10.md).
...
När du konfigurerar Intune i din organisation kan du skapa en RIA-specifik princip via [Azure Portal](https://docs.microsoft.com/intune-classic/deploy-use/azure-portal-for-microsoft-intune-mam-policies).
