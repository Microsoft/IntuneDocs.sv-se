...
Första steget är att kodsignera ditt appx-paket, se [signera appaket med SignTool](https://docs.microsoft.com/windows/uwp/packaging/sign-app-package-using-signtool)

## <a name="upload-your-app"></a>Ladda upp appen

Sedan laddar du upp den signerade appx-filen enligt beskrivningen i [ladda upp LOB Windows-app](lob-apps-windows.md)
