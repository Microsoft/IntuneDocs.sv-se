...
Kontrollera att du har konfigurerat Intune korrekt så att registrering är aktiverat innan du påbörjar felsökningen. Länkar till registreringssteg för varje plattform finns i [Registrera Android- och Standard Knox-enheter](android-enroll.md).
...
> Du kan undvika taket för enhetsregistrering genom att använda enhetsregistreringshanterare, vilket beskrivs i [Registrera enheter med enhetsregistreringshanteraren](device-enrollment-manager-enroll.md).
>
