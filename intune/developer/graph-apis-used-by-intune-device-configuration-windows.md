---
title: Graph-API:er för att konfigurera iOS-enheter i Microsoft Intune – Azure | Microsoft Docs
titleSuffix: ''
description: Se en lista med alla Graph API-entiteter med matchande Windows CSP och offset-URI på Windows 10-enheter och senare som används när du konfigurerar enheter i Microsoft Intune. Se matchande API och CSP för delade datorer, Endpoint Protection, Microsoft Defender Avancerat skydd, Identity Protection, Windows 10 Teams, kiosk och Windows Update for Business.
keywords: ''
...
Microsoft Intune använder [Graph API-entiteter](https://docs.microsoft.com/graph/api/resources/intune-graph-overview) (öppnar en annan Docs-sida) till att konfigurera enheter (**Intune** > **Enhetskonfiguration**) som kör Windows 10 och senare. I Graph API används CSP:er (konfigurationstjänstproviders) till att läsa, ställa in, ändra och ta bort konfigurationsinställningar på enheter.

Den här listan gäller för:

- Windows 10 och senare

Den här artikeln innehåller Graph-entiteter med matchande CSP:er och offset-URI:er i Windows 10.

Den här informationen är användbar i olika scenarier. Du kan till exempel se vad som används av Intune, se inställningar som ska inkluderas i anpassade konfigurationer av OMA-URI:er och så vidare. 

## <a name="windows-10-csps"></a>CSP:er i Windows 10

Du kan läsa mer om konfigurationstjänstproviders i Windows 10 i [referensen för konfigurationstjänstproviders](https://docs.microsoft.com/windows/client-management/mdm/configuration-service-provider-reference) (öppnar en annan Docs-sida).

## <a name="graph-api-properties-to-csp-mapping"></a>Mappning av Graph API-egenskaper till CSP:er

I den här listan visas de flesta Graph API-entiteter som Microsoft Intune använder för konfiguration av Windows 10-enheter. Dessutom visas motsvarande CSP och offset-URI i Windows 10.

Om du vill se vilka Windows 10-versioner som följande API:er gäller för använder du [referensen för konfigurationstjänstproviders](https://docs.microsoft.com/windows/client-management/mdm/configuration-service-provider-reference) för Windows 10 (öppnar en annan Docs-sida).
...
### <a name="sharedpcconfigurationaccountmanagerpolicy-windows-holographic-for-business-edition-targeted-devices"></a>SharedPCConfiguration.AccountManagerPolicy (enheter inriktade på Windows Holographic for Business) 
...
**CSP**: E/T Endast Graph API-anrop **Offset-URI**: E/T Endast Graph API-anrop
...
**Offset-URI**: /ProxyAddress, /Exceptions och /UseProxyForLocalAddresses
...
**Offset-URI**: /MOMAgent/WorkspaceID och /MOMAgent/WorkspaceKey
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**Offset-URI**: /MaintenanceHoursSimple/Hours/Duration och /MaintenanceHoursSimple/Hours/StartTime
...
**CSP**: E/T – Endast Graph API **Offset-URI**: E/T – Endast Graph API
...
- [Översikt över enhetskonfiguration](../configuration/device-profiles.md)
- [Referens till konfigurationstjänstproviders](https://docs.microsoft.com/windows/client-management/mdm/configuration-service-provider-reference) (öppnar en annan Docs-sida)
