...
![Exportera loggdata till Azure Monitor genom att Exportera datainställningar i Intune](./media/audit-logs-export-data-settings.png)
...
![Välj granskningsloggar i Intune för att se åtgärder och datum när händelser inträffade](./media/monitor-audit-logs.png "Granskningsloggar")
...
![Få mer specifik information om vem som gjorde vad i granskningsloggar i Intune](./media/monitor-audit-log-detail.png "Information om granskningslogg")
