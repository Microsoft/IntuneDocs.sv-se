                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Intune i Azure Portal</h3>
                                            <p>Microsoft Intune är tillgängligt i Azure Portal. Lär dig mer om hur du hanterar enheter och appar i den nya portalen. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Vad är Intune for Education?</h3>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Kom igång med Intune</h3>
                                            <p>Lär dig grunderna: Skapa en grupp och en användare. Registrera enheter. Tilldela principer och appar.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Var är Intune-funktionen i Azure?</h3>
                                            <p>Om du är van använda Intune på den klassiska konsolen beskriver den här artikeln hur du hittar funktionen i Intune i Azure.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Se <a href="/intune/what-is-intune">all Intune-dokumentation</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Se <a href="/intune/what-is-intune">all introduktionsdokumentation</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Se <a href="/intune-classic/plan-design/introduction">all dokumentation om plandistributionen</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Se <a href="/intune/device-enrollment">all dokumentation med instruktioner</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul id="manage-troubleshoot" class="cardsC">
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Kända problem</h3>
                                            <p>Läs om kända problem i Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Se <a href="/intune-classic/troubleshoot/general-troubleshooting-tips-for-microsoft-intune">all felsökningsdokumentation</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
            ...
            <ul id="sdkstools">
                <li>
                    ...
                    <ul id="sdkstools-all" class="cardsC">                       
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Vill du se all dokumentation? Se <a href="/intune-classic/understand-explore/introduction-to-microsoft-intune">all Intune-dokumentation</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
