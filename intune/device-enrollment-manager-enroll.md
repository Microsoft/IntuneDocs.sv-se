...
>[!NOTE]
>DEM-registreringsmetoden kan inte användas med följande registreringsmetoder: [Apple Configurator med installationsassistent](apple-configurator-setup-assistant-enroll-ios.md), [Apple Configurator med direktregistrering](apple-configurator-direct-enroll-ios.md) eller [program för enhetsregistrering](device-enrollment-program-enroll-ios.md). 
