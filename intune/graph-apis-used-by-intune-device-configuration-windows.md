...
**CSP**: Saknas-Graph API **offset-URI**: Saknas-Graph API
...
- [Översikt över enhets konfiguration](device-profiles.md)
- [Konfigurations tjänst leverantörs referens](https://docs.microsoft.com/windows/client-management/mdm/configuration-service-provider-reference) (öppnar en annan webbplats för dokument)
