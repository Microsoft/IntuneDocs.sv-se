...
| Administratören kan inte konfigurera en appskyddsprincip i Azure Portal | IT-administratören kan inte konfigurera appskyddsprinciper i Azure Portal. | Följande användarroller har åtkomst till Azure Portal: <ul><li>Global administratör, som du kan ställa in i den [Microsoft 365 Administrationscenter](https://admin.microsoft.com/)</li><li>Ägare, som du kan ställa in i [Azure-portalen](https://portal.azure.com/).</li><li>Deltagare, som du kan ställa in i [Azure-portalen](https://portal.azure.com/).</li></ul> Se [Rollbaserad administrationskontroll (RBAC) med Microsoft Intune](role-based-access-control.md) för hjälp med att konfigurera dessa roller.|
