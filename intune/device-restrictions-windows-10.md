...
ms.locfileid: "52728777"
---
# <a name="windows-10-and-newer-device-restriction-settings-in-microsoft-intune"></a>Inställningar av enhetsbegränsning för Windows 10 (och senare) i Microsoft Intune

Den här artikeln visar en lista och beskriver alla inställningar av enhetsbegränsningar som du kan konfigurera för Windows 10-enheter. Dessa inställningar läggs till en profil för enhetskonfiguration som sedan tilldelas eller distribueras till dina enheter med Microsoft Intune.
...
- **Betrodda enheter**: Välj om den här appen kan använda betrodda enheter, t.ex. maskinvara som du redan har anslutit eller som medföljer den här datorn. Du kan t.ex. använda tv-apparater, projektorer osv. som betrodda enheter.
...
- **Microsoft-kompatibilitetslista**: **Blockera** förhindrar Microsoft-kompatibilitetslistan i Microsoft Edge. Med den här listan från Microsoft kan Edge korrekt visa webbplatser med kända kompatibilitetsproblem. **Inte konfigurerad** tillåter att en Microsoft-kompatibilitetslista används.
...
- **Helskärmsläge**: Identifierar den typ av helskärmsläge som stöds av principen. Alternativen är:
  ...
  - **Inte konfigurerad** (standard): Den här principen aktiverar inte helskärmsläge på enheten.
