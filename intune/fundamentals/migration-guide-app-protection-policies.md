...
1. [Skapa en appskyddsprincip](../apps/app-protection-policies.md#create-an-app-protection-policy)
2. [Distribuera en princip](../apps/app-protection-policies.md#deploy-a-policy-to-users)
