...
### <a name="process-flow-to-create-intunewin-file"></a>Processflöde för att skapa .intunewin-fil
   ...
   ![Processflöde för att skapa en .intunewin-fil](./media/apps-win32-app-management/prepare-win32-app.svg)
...
### <a name="process-flow-to-add-a-win32-app-to-intune"></a>Processflöde för att lägga till en Win32-app till Intune
   ...
   ![Processflöde för att lägga till en Win32-app till Intune](./media/apps-win32-app-management/add-win32-app.svg)
