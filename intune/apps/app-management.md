...
<sup>1</sup> Överväg att använda [Windows informationsskydd](../windows-information-protection-configure.md) för att skydda appar på enheter som kör Windows 10.<br>
