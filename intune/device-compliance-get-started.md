...
> [!IMPORTANT]
> Intune följer enhetens incheckningsschema för alla efterlevnadsutvärderingar på enheten. [Mer information om enhetens incheckningsschema](device-profile-troubleshoot.md#how-long-does-it-take-for-mobile-devices-to-get-a-policy-or-apps-after-they-have-been-assigned).
...
Intune använder [villkorsstyrd åtkomst](https://docs.microsoft.com/azure/active-directory/conditional-access/overview) i Azure Active Directory (AD) (öppnar en annan dokumentwebbplats) för att tvinga fram efterlevnaden. När en enhet registreras i Intune startas även registreringen i Azure AD och enhetens information uppdateras i Azure AD. Enhetens efterlevnadsstatus är viktig information. Efterlevnadsstatusen används av villkorsstyrda åtkomstprinciper för att blockera eller tillåta åtkomst till e-post eller andra organisationsresurser.
...
- I [Villkorsstyrd åtkomst](conditional-access.md) och [Vanliga sätt att använda villkorsstyrd åtkomst på](conditional-access-intune-common-ways-use.md) beskrivs den här funktionen i relation till Intune.
...
## <a name="non-compliance-and-conditional-access-on-the-different-platforms"></a>Inkompatibilitet och villkorsstyrd åtkomst på olika plattformar
